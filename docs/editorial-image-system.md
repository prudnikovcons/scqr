...
## Вторичный слой архива
- Для нормализованного legacy-архива допускаются аккуратные `secondary`-обложки.
- Формат: `secondary-<rubric-slug>-hero.svg`
- Назначение: не конкурировать с премиальными AI-обложками, а держать слабые старые карточки в одном редакционном стандарте.
- Использование: годятся для архива, рубрик и внутренних страниц, но главная должна по возможности опираться на premium-обложки.
